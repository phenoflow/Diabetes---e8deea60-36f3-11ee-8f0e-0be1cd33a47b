...
steps:
  ...
  noninsulindependent-diabetes---secondary:
    run: noninsulindependent-diabetes---secondary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  diabetes-malnutritionrelated---secondary:
    run: diabetes-malnutritionrelated---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: noninsulindependent-diabetes---secondary/output
  diabetes-unspecified---secondary:
    run: diabetes-unspecified---secondary.cwl
    out:
    - output
    in:
      inputModule:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-malnutritionrelated---secondary/output
  diabetes---secondary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: diabetes-unspecified---secondary/output
